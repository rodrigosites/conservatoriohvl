...
(function() {
  $(document).on('ready page:load', function(evt) {
    $('#aluno_rg').mask('ZZ.ZZZ.ZZZ.ZZZ.ZZZ-Z', {
      reverse: true,
      translation: {
        Z: {
          pattern: /[A-Za-z0-9]/
    ...
    return $('#aluno_desde').mask('00/00/0000');
  });

  $(document).on('change', '#aluno_cliente', function(evt) {
...
(function() {
  $(document).on('ready page:load', function(evt) {
    ...
    return $('#circular_taxa_matricula').mask('099,00');
  });

}).call(this);
(function() {
  $(document).on('ready page:load', function(evt) {
    $('#cliente_rg').mask('ZZ.ZZZ.ZZZ.ZZZ.ZZZ-Z', {
      reverse: true,
      translation: {
        Z: {
          pattern: /[A-Za-z0-9]/
    ...
    $('#cliente_uf').mask('AA');
    return $('#cliente_nascimento').mask('00/00/0000');
  });

}).call(this);
(function() {
  $(document).on('ready page:load', function(evt) {
    return $('#curso_valor').mask('099,00');
  });
...
(function() {
  $(function() {
    $(document).on('ready page:load', function(evt) {
      return $('#data').mask('00/00/0000');
    });
    $(document).on('change', '#folhapagamento_mes', function(evt) {
    ...
    $(document).on('change', '#folhapagamento_ano', function(evt) {
      if ($('#folhapagamento_ano option:selected').val().length) {
        if ($('#folhapagamento_mes option:selected').val().length) {
          return $('#button').prop("disabled", false);
        }
    ...
    return $(document).on('click', '#button', function(evt) {
      return $.ajax({
        url: "/visualiza_folha",
        type: "GET",
        dataType: "script",
...
(function() {
  $(function() {
    $(document).on('ready page:load', function(evt) {
      ...
      return $('#diferenciado_horario').hide();
    });
    return $(document).on('change', '#diferenciado_check', function(evt) {
      if ($('#diferenciado_check').prop('checked')) {
        $("option:selected").prop("selected", false);
        $('#horario_horario').prop("disabled", true);
        $('#horario_div').hide();
        return $('#diferenciado_horario').show();
      } else {
...
(function() {
  $(function() {
    var valor_normal;
    valor_normal = 0;
    $(document).on('change', '#matricula_curso_id', function(evt) {
      if ($('#matricula_curso_id option:selected').val().length) {
        ...
        return $('#pratica_horario_id').append($('<option value>Primeiro selecione o professor...</option>'));
      } else {
        $('#professor_id').empty();
        return $('#professor_id').append($('<option value>Primeiro selecione o curso...</option>'));
      }
    });
    $(document).on('change', '#matricula_curso_id', function(evt) {
      if ($('#matricula_curso_id option:selected').val().length) {
    ...
    $(document).on('change', '#tipo_teoria', function(evt) {
      if ($('#tipo_teoria option:selected').val().length) {
        ...
        return $('#teorica_teoria').val($('#tipo_teoria option:selected').val());
      } else {
        ...
        return $('#horario_teoria_div').show();
      }
    });
    $(document).on('change', '#matricula_curso_id', function(evt) {
      if ($.trim($('#matricula_curso_id option:selected').text()) === 'Teoria' || $.trim($('#matricula_curso_id option:selected').text()) === 'Musicalização Infantil') {
        ...
        return $('#matricula_teoria_ano').val(99);
      } else {
        $('#matricula_teoria_div').show();
        $('#professor_teoria_div').show();
        $('#horario_teoria_div').show();
        return $('#tipo_teoria_div').show();
      }
    });
    $(document).on('change', '#professor_id', function(evt) {
    ...
    $(document).on('change', '#professor_teoria_id', function(evt) {
      if ($('#professor_teoria_id option:selected').val().length) {
        ...
        return $('#teorica_horario_id').append($('<option value>Primeiro selecione o professor de teoria...</option>'));
      }
    });
    $(document).on('change', '#matricula_teoria_ano', function(evt) {
      if ($.trim($('#matricula_teoria_ano option:selected').text()) === 'Formado em Teoria') {
        $('#professor_teoria_div').hide();
        return $('#horario_teoria_div').hide();
      } else {
        $('#professor_teoria_div').show();
        return $('#horario_teoria_div').show();
      }
    });
    $(document).on('change', '#desconto_check', function(evt) {
      var valor_desconto;
      if ($('#desconto_check').prop('checked')) {
        ...
        return $('#matricula_valor_mensal').val(valor_desconto);
      } else {
        return $('#matricula_valor_mensal').val(valor_normal);
      }
    });
    $(document).on('ready page:load', function(evt) {
      return $('#matricula_curso_id').val('');
    });
    return $(document).on('ready page:load', function(evt) {
      return $('#matricula_data_matricula').mask('00/00/0000');
    });
  });
...
(function() {
  $(document).on('ready page:load', function(evt) {
    $('#professor_rg').mask('ZZ.ZZZ.ZZZ.ZZZ.ZZZ-Z', {
      reverse: true,
      translation: {
        Z: {
          pattern: /[A-Za-z0-9]/
    ...
    return $('#professor_nascimento').mask('00/00/0000');
  });
